...
A modified [Fonts.Mod](https://raw.githubusercontent.com/io-core/Edit/master/Fonts.Mod) loads Oberon font data or PCF font data conditionally on the format of the font as identified by the first several bytes of the file.
...
`Edit.Mod` gains an `InsertUnicode` function, the `DeleteChar` function in `GraphicFrames.Mod` is adapted to variable-length codepoints. The remainder of the changes primarily consist of changing `GetPat` to `GetUniPat`, changing comparisons of `c `(type `CHAR`) to comparisons of `codepoint` (type `INTEGER`), making calls to `Texts.ReadUnicode` instead of `Texts.Read` (and likewise for `Write`). Changes are required in [Texts.Mod](https://github.com/io-core/Edit/blob/master/Texts.Mod) [Draw.Mod](https://github.com/io-core/Draw/blob/master/Draw.Mod), [Edit.Mod](https://github.com/io-core/Edit/blob/master/Edit.Mod), [Fonts.Mod](https://github.com/io-core/Edit/blob/master/Fonts.Mod), [GraphicFrames.Mod](https://github.com/io-core/Draw/blob/master/GraphicFrames.Mod), [Graphics.Mod](https://github.com/io-core/Draw/blob/master/Graphics.Mod), [Input.Mod](https://github.com/io-core/Oberon/blob/master/Input.Mod), [Net.Mod](https://github.com/io-core/System/blob/master/Net.Mod), [Oberon.Mod](https://github.com/io-core/Oberon/blob/master/Oberon.Mod), [ORP.Mod](https://github.com/io-core/Build/blob/master/ORP.Mod), [System.Mod](https://github.com/io-core/System/blob/master/System.Mod), and [TextFrames.Mod](https://github.com/io-core/Edit/blob/master/TextFrames.Mod). 
...
![font example](https://github.com/io-core/Technotes/blob/master/images/fonts.png "font example")
